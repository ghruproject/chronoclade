...
- **Role:** Close the evidence package cleanly; do not append an ESS or not-applicable method explainer to the visual report.
...
- **Don't** append an ESS or not-applicable explainer to a report generated by this likelihood-based workflow.
